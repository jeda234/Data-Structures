...
void StudentTests() {
  ...
  assert (ja.numElementsInBin(5) == 0);
  assert (ja.numElementsInBin(6) == 1);
  assert (ja.getElement(1,0) == 3.4);
  assert (ja.getElement(1,1) == 2.1);
  assert (ja.getElement(1,2) == 3.5);
  assert (ja.getElement(3,0) == 4.1);
  assert (ja.getElement(3,1) == 6.5);
  assert (ja.getElement(6,0) == 2.4);
